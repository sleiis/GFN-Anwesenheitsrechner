...
{
    /// <summary>
    /// Custom control for minimizing the window state.
    /// </summary>
    public class CustomMini : Control
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomMini"/> class.
        /// </summary>
        public CustomMini()
        {
            SetStyle(
        ...
        /// <summary>
        /// Handles the click event to minimize the window state.
        /// </summary>
        /// <param name="e">The event arguments.</param>
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (var G = Graphics.FromImage(B))
            {
                ...
                // Draw minimize icon (dot as big as the button and centered)
